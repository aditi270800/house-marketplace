        ...
        const onSubmit = async (e) => {
          ...
          if (geolocationEnabled) {
            const response = await fetch(
                `http://api.positionstack.com/v1/forward?access_key=46022ab319d8a45748391617582e75e6&query=${address}`
            );
                ...
                <form onSubmit={onSubmit}>
                  ...
                  <div className='formButtons'>
                    <button
                      ...
                      id='type'
                      value='sale'
                      onClick={onMutate}>Sell</button>
                    <button
                      type='button'
                      className={type === 'rent' ? 'formButtonActive' : 'formButton'}
                      id='type'
                      value='rent'
                      onClick={onMutate}>Rent</button>
        </div>
